...
typedef unsigned int dz_index_in_queuelist;
...
#define DZ_INDEX_IN_QUEUELIST_INVALID  ((dz_index_in_queuelist)-1) /**< Index in queuelist of tracks has not been set yet, not a valid value. */
#define DZ_INDEX_IN_QUEUELIST_PREVIOUS ((dz_index_in_queuelist)-2) /**< Play the previous track in the queuelist of tracks. */
#define DZ_INDEX_IN_QUEUELIST_CURRENT  ((dz_index_in_queuelist)-3) /**< Play the current track in the queuelist of tracks. */
#define DZ_INDEX_IN_QUEUELIST_NEXT     ((dz_index_in_queuelist)-4) /**< Play the next track in the queuelist of tracks. */
 ...
 */
LIBDEEZER_API bool dz_player_event_get_queuelist_context(dz_player_event_handle self,
                                                        dz_streaming_mode_t *out_streaming_mode,
                                                        dz_index_in_queuelist *out_idx);
...
/**
 * @brief Player tracklist repeat modes.
 *
 ...
 */
LIBDEEZER_API dz_error_t dz_player_set_repeat_mode(dz_player_handle self,
                                                   dz_activity_operation_callback cb,
                                                   void* operation_userdata,
 ...
 */
LIBDEEZER_API dz_error_t dz_player_enable_shuffle_mode(dz_player_handle self,
                                                       dz_activity_operation_callback cb,
                                                       void* operation_userdata,
 ...
 *                           * Radios (aka mixes) also support #DZ_INDEX_IN_QUEUELIST_CURRENT or #DZ_INDEX_IN_QUEUELIST_NEXT.\n
 *                           * Albums & Playlists support #DZ_INDEX_IN_QUEUELIST_PREVIOUS, #DZ_INDEX_IN_QUEUELIST_CURRENT
 *                           or #DZ_INDEX_IN_QUEUELIST_NEXT.
 */
